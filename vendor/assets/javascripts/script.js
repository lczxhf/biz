$(function(){
	$(".nav").toggle(function(){
		$(this).next(".nav_menu").show();
		
		},function(){
		$(this).next(".nav_menu").hide();
...
$(function(){
	...
	var input_searchs=$('input[type=search]');
	var input_texts=$('input[type=text]');
	var textareas=$('textarea');
	var input_passwords=$('input[type=password]');
	
	
	var isIOS = (/iphone|ipad/gi).test(navigator.appVersion);
	
	if (isIOS) {
		input_searchs.focusin(subfnin);
		input_texts.focusin(subfnin);
		textareas.focusin(subfnin);
		input_passwords.focusin(subfnin);
		
		input_searchs.focusout(subfnout);
		input_texts.focusout(subfnout);
		textareas.focusout(subfnout);
		input_passwords.focusout(subfnout);
	}
